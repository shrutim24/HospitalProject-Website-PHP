...
<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
					<h1> &nbsp &nbsp &nbsp &nbsp&nbsp&nbsp  &nbsp hospital | Patient Login  </h1>

				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							<legend>
								&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp  Sign in to your account
							</legend>
							<br>
							<p>
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> hospital</span>. <span>All rights reserved</span>
					</div>
